...
import {isValidVersionString} from './version.js';
    ...
    while (isLastPage === false) {
      ...
      for (const item of response.data.items) {
        ...
        try {
          ...
          consola.debug(`[GitHub Bot] Failed to fetch tooth metadata of ${
        ...
        try {
          ...
          consola.debug(`[GitHub Bot] Failed to fetch version list of ${
              owner}/${repo}: ${err.message}`);
          continue;
        }
