...
export class ToothMetadata {
   ...
   * @param {string} source The source repository.
   * @param {string[]} tags The tags.
   * @param {Object.<string, string>} dependencies The dependencies.
   * @param {Object.<string, string>} prerequisites The prerequisites.
   */
  constructor(
      toothPath, version, name, description, author, source, tags, dependencies,
      prerequisites) {
    ...
    /** @type {string} */ this.source_ = source;
    /** @type {string[]} */ this.tags_ = tags;
    /** @type {Object<string, string>} */ this.dependencies_ = dependencies;
    /** @type {Object<string, string>} */ this.prerequisites_ = prerequisites;
  }
   ...
   * @return {string} The source repository.
   */
  getSource() {
    return this.source_;
  }
   ...
   * @return {Object.<string, string>} The prerequisites.
   */
  getPrerequisites() {
...
export function createToothMetadataFromJsonString(jsonString) {
  ...
  if (!((new Ajv()).compile(JSON_SCHEMA))(jsonObject)) {
    throw new Error('tooth.json is invalid');
  }
...
function createToothMetadataFromJsonV1(jsonObject) {
  ...
  const toothMetadata = new ToothMetadata(
      ...
      jsonObject.information.author || '', jsonObject.information.source || '',
      jsonObject.information.tags || [], dependencies, {});
...
function createToothMetadataFromJsonV2(jsonObject) {
  const toothMetadata = new ToothMetadata(
      ...
      jsonObject.info.source || '', jsonObject.info.tags || [],
      jsonObject.dependencies, jsonObject.prerequisites);
